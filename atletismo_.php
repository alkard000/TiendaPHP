...
<?php
  ...
  $sql= " SELECT * FROM info_cloth WHERE id_cat_type=18 AND id_cloth_genre=3";
...
<?php 
  ...
  $sql_articulos = " SELECT * FROM info_cloth WHERE id_cat_type=18 AND id_cloth_genre=3 LIMIT :iniciar, :narticulos ";
