...
<section class="container-mens">
      <div class="img-mens">
        <img class="parallax" src="img/accesorios_page.jpg" alt="MENS">
      </div>
      <ul class="txt-mens">
    ...
    <div class=" contenedor section-hombre">
      <div class="section-hombre-text">
        <img  src="img/hydroblade.png" style="width:80%; heigth:80%;" alt="accesorio">
      </div>
      <div class="section-hombre-img">
        <h3>Accesorios para ser el Mejor</h3>
        <a href="#" class="button transparent">ver catalogos</a>
        <p>Usa complementos deportivo d ela mas alta gamma, para ti y tu equipo. <br>Accesorios criticamente seleccionados por expertos en el tema</p>
      </div>
    </div>
