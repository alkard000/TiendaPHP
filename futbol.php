...
<?php
  ...
  $sql= " SELECT * FROM info_cloth WHERE id_cloth_cat=2";
...
<div class="menu-resumen">
  <ul class="section-resumen" >
    ...
    <li><a href="futbol.php?pagina=1" >Futbol</a></li>
  </ul>
</div>
<section class="contenedor seccion">
  <h2>Deporte de Resistencia</h2>
...
<?php 
  ...
  $sql_articulos = " SELECT * FROM info_cloth WHERE id_cloth_cat=2 LIMIT :iniciar, :narticulos ";
...
<nav class="">
  <ul class="list-pag">
    ...
    <i class="fas fa-arrow-circle-left"></i>
      <a class="but" href="futbol.php?pagina=<?php echo $_GET['pagina']-1; ?>">
        Anterior
      </a>
    </li>
    ...
    <li class="page-item <?php echo $_GET['pagina']== $i + 1 ? 'activos' : ''; ?>">
      <a class="but " href="futbol.php?pagina=<?php echo $i + 1; ?>">
        <?php echo $i + 1; ?>
      </a>
    </li>
