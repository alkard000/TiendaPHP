...
<?php
  ...
  $sql= " SELECT * FROM info_cloth WHERE id_cloth_genre=2";
...
<div class="menu-resumen">
  <ul class="section-resumen" >
    ...
    <li><a href="womans.php?pagina=1">Mujeres</a></li>
  </ul>
</div>
<section class="contenedor seccion">
  <h2>Ropa para Homres</h2>
...
<?php 
  ...
  $sql_articulos = " SELECT * FROM info_cloth WHERE id_cloth_genre=2 LIMIT :iniciar, :narticulos ";
...
<nav class="">
  <ul class="list-pag">
    ...
    <i class="fas fa-arrow-circle-left"></i>
      <a class="but" href="womans.php?pagina=<?php echo $_GET['pagina']-1; ?>">
        Anterior
      </a>
    </li>
    ...
    <li class="page-item <?php echo $_GET['pagina']== $i + 1 ? 'activos' : ''; ?>">
      <a class="but " href="womans.php?pagina=<?php echo $i + 1; ?>">
        <?php echo $i + 1; ?>
      </a>
    </li>
