<?php include_once 'includes/templates/header.php';?>
    ...
    <section class="container-mens">
      <div class="img-mens">
        <img class="parallax" src="img/women.jpg" alt="MENS">
      </div>
      <ul class="txt-mens">
        <h3>PARA MUJERES</h3>
