...
<?php
  require_once('includes/functions/bd_conection_cloth2.php');
  $sql= " SELECT * FROM info_cloth2 WHERE id_cat_type2=3 ";
...
<div class="menu-resumen">
  <ul class="section-resumen" >
    ...
    <li><a href="womans.php?pagina=1">Mujeres<i class="fas fa-chevron-right"></i></a></li>
    <li><a href="cortavientowoman.php?pagina=1" >Cortaviento</a></li>
  </ul>
</div>
<section class="contenedor seccion">
  <h2>El frio no es excusa</h2>

<?php 
  if(!$_GET){
    header('Location:cortavientowoman.php?pagina=1');
  }
  $iniciar = ($_GET['pagina']-1) * $pag;

  $sql_articulos = " SELECT * FROM info_cloth2 WHERE id_cat_type2=3 LIMIT :iniciar, :narticulos ";
...
<div class="mas-vendidos v-pehmea" style="background-image: url(<?php echo $articulo['url_images']; ?>) ">
          ...
          <ul class="content-block">
            ...
            <li><a href="product2.php?id_cloth= <?php echo $articulo['id_cloth'] ?>" class="tranparent button-vendidos"><i class="fas fa-arrow-circle-right"></i>Ver Detalles</a></li>
          </ul>
        </div>
<?php endforeach ?>
...
<nav class="">
  <ul class="list-pag">
    ...
    <i class="fas fa-arrow-circle-left"></i>
      <a class="but" href="cortavientowoman.php?pagina=<?php echo $_GET['pagina']-1; ?>">
        Anterior
      </a>
    </li>
    ...
    <li class="page-item <?php echo $_GET['pagina']== $i + 1 ? 'activos' : ''; ?>">
      <a class="but " href="cortavientowoman.php?pagina=<?php echo $i + 1; ?>">
        <?php echo $i + 1; ?>
      </a>
    </li>
