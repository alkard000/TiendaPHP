...
<?php
  ...
  $sql= " SELECT * FROM info_cloth WHERE id_cloth_genre=1";
...
<div class="menu-resumen">
  <ul class="section-resumen" >
    ...
    <li><a href="mans.php?pagina=1">Hombres</a></li>
  </ul>
</div>
...
<?php 
  ...
  $sql_articulos = " SELECT * FROM info_cloth WHERE id_cloth_genre=1 LIMIT :iniciar, :narticulos ";
...
<nav class="">
  <ul class="list-pag">
    ...
    <i class="fas fa-arrow-circle-left"></i>
      <a class="but" href="mans.php?pagina=<?php echo $_GET['pagina']-1; ?>">
        Anterior
      </a>
    </li>
    ...
    <li class="page-item <?php echo $_GET['pagina']== $i + 1 ? 'activos' : ''; ?>">
      <a class="but " href="mans.php?pagina=<?php echo $i + 1; ?>">
        <?php echo $i + 1; ?>
      </a>
    </li>
