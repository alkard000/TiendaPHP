...
<?php
  ...
  $sql= " SELECT * FROM info_cloth2 WHERE id_cat_type2=6 ";
...
<section class="contenedor seccion">
  <h2>Comodidad y resistencia</h2>

<?php 
  if(!$_GET){
    header('Location:short&falda.php?pagina=1');
  }
  $iniciar = ($_GET['pagina']-1) * $pag;

  $sql_articulos = " SELECT * FROM info_cloth2 WHERE id_cat_type2=6 LIMIT :iniciar, :narticulos ";
...
<nav class="">
  <ul class="list-pag">
    ...
    <i class="fas fa-arrow-circle-left"></i>
      <a class="but" href="short&falda.php?pagina=<?php echo $_GET['pagina']-1; ?>">
        Anterior
      </a>
    </li>
    ...
    <li class="page-item <?php echo $_GET['pagina']== $i + 1 ? 'activos' : ''; ?>">
      <a class="but " href="short&falda.php?pagina=<?php echo $i + 1; ?>">
        <?php echo $i + 1; ?>
      </a>
    </li>
